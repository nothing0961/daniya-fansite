...
| 语言       | TypeScript                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 样式       | Tailwind CSS v4 + 星空泡泡主题（粉白渐变 + 毛玻璃 + 泡泡光晕动画）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 内容       | MDX 本地文件（`content/posts/`），支持草稿预览                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 媒体       | ImgURL 图床（图片）+ B站 iframe（视频，BV号嵌入）+ B站封面图白名单                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 作品类型     | 7 类（插画/截屏/漫画/视频/文章/COS/其他）+ `character` 字段（DANIYA/OTHER 枚举）关联角色                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 数据库      | Prisma + Neon PostgreSQL (serverless)，模型：User / Account / Bookmark / PostLike / PendingPost / VerificationToken / Comment                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 认证       | Auth.js v5 · Credentials 用户名+密码（bcryptjs + JWT）+ 双图形验证码 + 未注册专属弹窗                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 后台管理     | 自建 Admin CRUD — MDX 编辑器 + ImgURL 上传代理 + 投稿人工审核（站长，403 守卫）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 审核工作流    | PendingPost 三态 + 上传限流（3/日+8/日）+ 投稿预览独立路由 `/dashboard/submissions/[slug]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 用户侧入口    | Header 导航胶囊 + 投稿页（额度卡片）+ 我的投稿 4 Tab + 概览页（头像/退出/快捷入口）                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 权限分级     | 普通用户（概览/收藏/投稿）vs 站长（+审核）；敏感 API 双锁（proxy + `requireAdmin()`）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 密码       | bcryptjs v3（salt 10 轮）+ JWT session（头像实时同步）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 评论       | 自建 — Prisma Comment 模型 + 3 API + 前端组件；Zod 1-1000 字校验；删除权限：作者 or 站长                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 音乐播放器    | HoverCard 悬停面板（openDelay=80ms/closeDelay=200ms）+ 点击仅切播放/暂停 + 移动端 fallback                                                                                                                                                                                                    |
| 🤖 AI 聊天 | 双轨方案（A: 智谱 GLM-4.7-Flash 永久免费 / B: 用户自定义 OpenAI 兼容）+ 5 层安全拦截 + 人设注入 + AES-GCM 零托管密钥 + SSRF 拦截 + 重试/fallback + B1 协议识别 6 类；6 env 变量；21 文件 75 cases |
| 测试       | Vitest + @testing-library + jsdom — **46 文件 / 340 passed / 1 todo**；三条铁律：① `npm test` 全绿 ② `tsc --noEmit` 0 errors ③ `npm run build` 成功 |
| 部署       | Netlify / Vercel（双平台；Vercel 有免费额度可正常更新）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| 22  | 7月12      | **AI 聊天双轨方案（核心）**                 | 轨道 A 智谱 GLM-4.7-Flash 永久免费 + 轨道 B 用户自定义 AES-GCM 零托管；6 env；5 层拦截 + SSRF + 人设注入 + 重试/fallback + B1 协议识别 6 类 + FAB 齿轮设置；废弃 AstrBot 旧方案  | 4 新 + **15 tests 新** | **+75 cases**（21 文件 / 旧 22 零回归） |
